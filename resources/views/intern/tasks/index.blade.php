    ...
    <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
     ...
                </td>
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                <a href="{{route('intern.tasks.edit', $task->id)}}" class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 text-white bg-green-700 cursor-pointer px-3 py-2.5 font-normal text-xs leading-3 shadow-md rounded">Edit</a>
                <br>
              </td>
            </tr>
            @endif
